...
<%   
		...
		try{
               ...
               try{
                PreparedStatement ps=con.prepareStatement("UPDATE bed SET bed_price = '"+bed_price+"' FROM bed INNER JOIN hospital ON hospital.hospital_id = bed.hospital_id WHERE hospital_username = '"+hospital_username+"'  AND bed_category = '"+bed_type+"';");    
                out.println("<p font-size: 2em;>"+bed_type+" price of beds updated</p>");
                ps.executeQuery();
               }catch(Exception e){
                   out.println("");
               }
            ...
            out.print("Connection with database failed");
        }       	
	 %>
