...
<%   
        ...
        String bed_available= request.getParameter("bed_available");
        ...
        String bed_type = request.getParameter("bed_type");
               ...
               Connection con= DriverManager.getConnection("jdbc:sqlserver://localhost;database=mini_project_sem_3;IntegratedSecurity=true");
                    ...
                    PreparedStatement ps=con.prepareStatement("INSERT INTO bed (bed_category,bed_price,bed_count,bed_available,hospital_id) VALUES (?,?,?,?,(SELECT hospital_id FROM hospital WHERE hospital.hospital_username = '"+hospital_username+"'))  SELECT hospital.hospital_id,hospital_username FROM hospital INNER JOIN bed ON hospital.hospital_id = bed.hospital_id WHERE hospital_username = '"+hospital_username+"'; ");
                    ps.setString(1,bed_type);
                    ps.setString(2,bed_price);
                    ps.setString(3,bed_count);    
                    ps.setString(4,bed_available);
                    out.println("<p font-size: 2em;>"+bed_type+" new bed data added</p>");
