...
<%   
        ...
        String hospital_specialization = request.getParameter("hospital_specialization");
		try{
               ...
               try{  
                    ...
                    PreparedStatement ps=con.prepareStatement("UPDATE hospital SET hospital_specialization = '"+hospital_specialization+"' WHERE hospital_username='"+hospital_username+"'");    
                    out.println("<p>Specialization updated</p>");
