...
<%   
		...
		try{
               ...
               try{  
                    ...
                    PreparedStatement ps=con.prepareStatement("UPDATE bed SET bed_available = '"+bed_available+"' FROM bed INNER JOIN hospital ON hospital.hospital_id = bed.hospital_id WHERE hospital_username = '"+hospital_username+"'  AND bed_category = '"+bed_type+"';");    
                    out.println("<p font-size: 2em;>"+bed_type+"Bed data updated</p>");
